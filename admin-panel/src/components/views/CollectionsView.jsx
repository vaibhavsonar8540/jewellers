...
import { ArrowLeft, Search, Plus, MoreVertical, Layers } from "lucide-react";

export default function CollectionsView({ items = [], onAdd, onBack }) {
        ...
        {filtered.length === 0 ? (
          <div className="p-12 text-center flex flex-col items-center justify-center space-y-3">
            ...
            <h3 className="text-base font-bold text-gray-900">
              {items.length === 0 ? "No Collections Found" : `No collections matching "${searchTerm}"`}
            </h3>
