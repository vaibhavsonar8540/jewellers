...
import { ArrowLeft, Search, Plus, MoreVertical, ListFilter } from "lucide-react";

export default function SubCategoryView({ items = [], onAdd, onBack }) {
        ...
        {filtered.length === 0 ? (
          <div className="p-12 text-center flex flex-col items-center justify-center space-y-3">
            ...
            <h3 className="text-base font-bold text-gray-900">
              {items.length === 0 ? "No Sub Categories Found" : `No sub categories matching "${searchTerm}"`}
            </h3>
